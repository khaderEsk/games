...
<body>
    ...
    <div id="controls">
        <a href="{{ url('player_computer/' . $user->id) }}"><button class="button">PLAYER VS COMPUTER</button></a><br /><br>
        <a href="{{ url('two_player/' . $user->id) }}"><button class="button">TWO PLAYER GAME</button></a><br /><br>
    </div>
