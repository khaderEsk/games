            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <form action="">
                            <div>
                                <input type="text" class="form-control" placeholder="Bank Number" />
                            </div>
                            <div>
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="Bank Account Owner" />
                            </div>
                            <div>
                                <input type="text" class="form-control" placeholder="IBAN" />
                            </div>
                            <div class="btn_box">
                                <a href="withdraw.html" class="btn btn-danger text-white mt-2 p-3">
                                    Withdraw Amount
                                </a>
                            </div>
                        </form>
                ...
                <div class="col-md-6">
                    <a href="" class="btn btn-primary w-100 p-4 ">
                    ...
                    <a href="" class="btn btn-secondary w-100 p-4 mt-2">
                    ...
                    <a href="" class="btn btn-light w-100 p-4 mt-2">
