...
<head>
    ...
    <title>Game Store | Sign up</title>
    ...
    <!-- Elegant Icons CSS -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/elegant-icons/1.0.1/style.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('slicknav.min.css') }}">
                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" class="site-btn"><a href="./profile.html" class="text-white">Sign up
                                    Now</a></button>
                        </form>
