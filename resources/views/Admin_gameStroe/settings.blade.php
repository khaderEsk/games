                                    ...
                                    <div class="col-lg-12">
                                        <div class="page-content my-account__edit">
                                            <div class="my-account__edit-form">
                                                <form id="passwordForm" name="account_edit_form"
                                                    ...
                                                    <fieldset class="name">
                                                        ...
                                                        <input class="flex-grow" type="text"
                                                            placeholder="Full Name" name="name" tabindex="0"
                                                            value="{{ $admin->name }}" aria-required="true"
                                                            required="">
                                                    </fieldset>
                                                    ...
                                                    <fieldset class="name">
                                                        ...
                                                        <input class="flex-grow" type="text"
                                                            placeholder="Mobile Number" name="phone" tabindex="0"
                                                            value="{{ $admin->phone }}" aria-required="true"
                                                            required="">
                                                    </fieldset>
                                                    ...
                                                    <fieldset class="name">
                                                        ...
                                                        <input class="flex-grow" type="text"
                                                            ...
                                                            value="{{ $admin->email }}" aria-required="true"
                                                            required="">
                                                    </fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12">
                                                                <fieldset class="name">
                                                                    <div class="body-title pb-3">Confirm new password
                                                                    ...
                                                                    <h5 id="password-error"
                                                                        style="display:none; color:red;">Passwords did
                                                                        not match!</h5>
                                                                </fieldset>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="my-3">
                                                                    <button type="submit" id="passwordForm"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('passwordForm').addEventListener('submit', function(event) {
                ...
                if (newPassword !== confirmPassword) {
                    ...
                    errorDiv.textContent = 'Passwords did not match!'; // Optional: Add error message text
                } else {
