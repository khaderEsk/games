                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    <h3 class="text-white">Transfers</h3>
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">Transfers</div>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <tbody>
                                                    @foreach ($governor as $item)
                                                        <tr>
                                                            ...
                                                            <th class="text-center">{{ $item->wallet->user->name }}
                                                            </th>
                                                            <th class="text-center">{{ $item->wallet->user->phone }}
                                                            </th>
                                                            <th class="text-center">{{ $item->amount }}</th>
                                                            <th class="text-center">{{ $item->address }}</th>
                                                            <th class="text-center">{{ $item->transferCompany }}</th>
                                                            <th class="text-center">{{ $item->created_at }}</th>
                                                            <th class="text-center">
                                                                <a href="{{ route('accept', ['id' => $item->id]) }}">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">ALAL & Nibras</div>
                        </div>
                    </div>
