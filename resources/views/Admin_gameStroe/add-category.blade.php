...
<head>
    ...
    <link rel="shortcut icon" href="admin/images/logo/fav.png">
    <link rel="apple-touch-icon-precomposed" href="admin/images/logo/fav.png">
                    ...
                    <div class="box-logo">
                        <a href="indexAdmin" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="admin/images/logo/logo.png"
                                data-light="admin/images/logo/logo.png" data-dark="images/logo/logo.png">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="images/logo/fav.png"
                                        data-light="images/logo/fav.png" data-dark="images/logo/fav.png"
                                        data-width="154px" data-height="52px" data-retina="images/logo/fav.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    <h3 class="text-white">Category infomation</h3>
                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="#" method="POST"
                                        ...
                                        <div class="bot">
                                            <div></div>
                                            <button class="tf-button w208" type="submit">Add New</button>
                                            <button class="tf-button w208" type="submit">Save Edit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
