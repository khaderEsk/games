...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{ asset('admin/images/avatar/user-1.png') }}">
                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">Transfer details</div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="wg-box mt-5">
                                    ...
                                    <div class="my-account__address-item col-md-6">
                                        <div class="my-account__address-item__detail">
                                            <p>name: {{ $governor->wallet->user->name }}</p>
                                            <p>address: {{ $governor->address }}</p>
                                            <p>phone: {{ $governor->wallet->user->phone }}</p>
                                ...
                                <div class="wg-box mt-5">
                                    ...
                                    <table class="table  table-bordered table-transaction">
                                        <tbody>
                                            <tr>
                                                <th>Total</th>
                                                <td>{{ $governor->amount }}</td>
                                                <th>Payment Mode</th>
                                                <td>{{ $governor->transferCompany }}</td>
                                                <th>Status</th>
