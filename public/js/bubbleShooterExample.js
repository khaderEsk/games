...
window.onload = function() {
    ...
    function init() {
        // Load images
        images = loadImages(["/img/bubble-sprites.png"]);
...
context.clearRect(level.x - 4, level.y - 4, level.width + 8, level.height + 4 - yoffset);

// Set the border style
context.strokeStyle = "#000000"; // لون الإطار (أسود)
context.lineWidth = 2; // سمك الإطار

// Draw the border
context.strokeRect(level.x - 4, level.y - 4, level.width + 8, level.height + 4 - yoffset);
